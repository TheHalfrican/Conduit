...
function ScriptRow({ script }: { script: Script }) {
  ...
  return (
    <tr
      ...
      className="border-b border-hub-border/50 hover:bg-hub-bg/50 cursor-pointer transition-colors"
    >
    ...
    <table className="w-full">
      <thead>
        <tr className="border-b border-hub-border text-left">
          <th className="py-2 px-3 text-xs font-medium text-hub-text-dim uppercase tracking-wider">
            Name
          </th>
          <th className="py-2 px-3 text-xs font-medium text-hub-text-dim uppercase tracking-wider">
            Category
          ...
          <th className="py-2 px-3 text-xs font-medium text-hub-text-dim uppercase tracking-wider text-right">
            Action
          </th>
        </tr>
      </thead>
